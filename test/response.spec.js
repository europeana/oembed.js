      ...
      context('and edm:isShownBy is present', () => {
        context('with ebucore dimensions', () => {
          ...
          it('defaults to ebucore dimensions', () => {
            assertWidthAndHeight(response(item), 1200, 900);
          });

          it('scales to fit maxWidth', () => {
            assertWidthAndHeight(response(item, { maxWidth: 200, maxHeight: 225 }), 200, 150);
          });

          it('scales to fit maxHeight', () => {
            assertWidthAndHeight(response(item, { maxWidth: 400, maxHeight: 100 }), 133, 100);
          });
        });
        ...
        context('without ebucore dimensions', () => {
          ...
          it('defaults to 400x225', () => {
            assertWidthAndHeight(response(item), 400, 225);
          });

          it('scales to fit maxWidth', () => {
            assertWidthAndHeight(response(item, { maxWidth: 200, maxHeight: 225 }), 200, 113);
          });

          it('scales to fit maxHeight', () => {
            assertWidthAndHeight(response(item, { maxWidth: 400, maxHeight: 100 }), 178, 100);
          });
        });
      });
